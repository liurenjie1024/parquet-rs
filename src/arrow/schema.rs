...
use schema::types::{SchemaDescPtr, Type, TypePtr};

use arrow_lib::datatypes::{DataType, Field, Schema};

use errors::{ParquetError::ArrowError, Result};
...
mod tests {
  ...
  use schema::{parser::parse_message_type, types::SchemaDescriptor};

  use arrow_lib::datatypes::{DataType, Field};
